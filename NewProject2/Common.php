...
//Connection Settings @0-3ADE1DBF
...
//Initialize Common Variables @0-8CCA33ED
...
CCConvertDataArrays();
$CCProjectStyle = "School";
$CCProjectDesign = "Simple";
...
//Connection1 Connection Class @-F6AE7073
class clsDBConnection1 extends DB_Adapter
{
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["Connection1"]);
        parent::Initialize();
...
//CCGetGroupID @0-A9953066
function CCGetGroupID()
{
    return CCGetSession("RegFormGroupID");
}
//End CCGetGroupID
...
function CCLoginUser($login, $password)
{
    ...
    if ($Result) {
        ...
        CCSetSession("RegFormGroupID", $db->f("group_id"));
...
//CCLogoutUser @0-D7FDD8C3
function CCLogoutUser()
{
    CCSetSession("UserID", "");
    CCSetSession("UserLogin", "");
    CCSetSession("RegFormGroupID", "");
