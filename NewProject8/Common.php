...
//Connection Settings @0-B3DEB1DA
...
//Initialize Common Variables @0-EF22BF72
...
$DefaultDateFormat = array("mm", "/", "dd", "/", "yyyy", " ", "h", ":", "nn", " ", "AM/PM");

$MainPage = new clsMainPage();
//End Initialize Common Variables

//InternetDB Connection Class @-509851E5
class clsDBInternetDB extends DB_Adapter
{
    function clsDBInternetDB()
    {
        $this->Initialize();
    }
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["InternetDB"]);
        parent::Initialize();
...
//End InternetDB Connection Class
