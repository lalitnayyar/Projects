...
//Class_Initialize Event @6-35F491B0
...
//Operation Method @6-CB894FFF
    function Operation()
    {
        ...
        $Redirect = "ThankYou.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
        if($this->Validate()) {
...
//DataSource Variables @6-9A7A0B35
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @6-515578D8
...
//Include events file @1-DDDADBD5
include_once("./contactForm_events.php");
