...
//Connection Settings @0-37407434
...
//Initialize Common Variables @0-513DBD8B
...
CCConvertDataArrays();
$CCProjectStyle = "Innovation";
$CCProjectDesign = "FarmSong";
...
//internet Connection Class @-3E31379B
class clsDBinternet extends DB_Adapter
{
    function clsDBinternet()
    {
        $this->Initialize();
    }
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["internet"]);
        parent::Initialize();
...
//CCGetUserID @0-1B8D6BFD
function CCGetUserID()
{
    return CCGetSession("PortalUserID");
}
//End CCGetUserID

//CCGetGroupID @0-027A8402
function CCGetGroupID()
{
    return CCGetSession("PortalGroupID");
}
//End CCGetGroupID

//CCGetUserLogin @0-A90208CE
...
function CCLoginUser($login, $password)
{
    ...
    if ($Result) {
        CCSetSession("PortalUserID", $db->f("user_id"));
        CCSetSession("PortalGroupID", $db->f("group_id"));
...
//CCLogoutUser @0-4E6625FF
function CCLogoutUser()
{
    CCSetSession("PortalUserID", "");
    CCSetSession("PortalGroupID", "");
