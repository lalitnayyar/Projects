...
//Connection Settings @0-4E1EEBFA
...
//Initialize Common Variables @0-DDE2B2D8
...
//Connection1 Connection Class @-72D086CA
...
//saconsult Connection Class @-6CCA8B58
class clsDBsaconsult extends DB_Adapter
{
    function clsDBsaconsult()
    {
        $this->Initialize();
    }
    ...
    {
        global $CCConnectionSettings;
        $this->SetProvider($CCConnectionSettings["saconsult"]);
        parent::Initialize();
        $this->DateLeftDelimiter = "'";
        $this->DateRightDelimiter = "'";
    }
...
//End saconsult Connection Class
