<?php
//Include Common Files @1-C16C5D88
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "EditOfficer.php");
...
class clsRecordofficers { //officers Class @33-5382B1A8
...
//Class_Initialize Event @33-69033BEE
    function clsRecordofficers($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record officers/Error";
        ...
        if($this->Visible)
        {
            ...
            $this->officer_name->Required = true;
            ...
            $this->officer_position->Required = true;
            ...
            $this->officer_email->Required = true;
        }
    }
//End Class_Initialize Event

//Initialize Method @33-C4A32503
    function Initialize()
    {
...
//CheckErrors Method @33-14B70196
...
} //End officers Class @33-FCB6E20C

class clsofficersDataSource extends clsDBinternet {  //officersDataSource Class @33-C92298ED

//DataSource Variables @33-11A7330D
    public $Parent = "";
    public $CCSEvents = "";
    public $CCSEventResult;
    public $ErrorBlock;
...
//DataSourceClass_Initialize Event @33-26A40B30
    function clsofficersDataSource(& $Parent)
    {
        ...
        $this->InsertFields["officer_name"] = array("Name" => "officer_name", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["officer_position"] = array("Name" => "officer_position", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->InsertFields["officer_email"] = array("Name" => "officer_email", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["officer_name"] = array("Name" => "officer_name", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["officer_position"] = array("Name" => "officer_position", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
        $this->UpdateFields["officer_email"] = array("Name" => "officer_email", "Value" => "", "DataType" => ccsText, "OmitIfEmpty" => 1);
    }
//End DataSourceClass_Initialize Event

//Prepare Method @33-A214ED75
    function Prepare()
    {
        global $CCSLocales;
        global $DefaultDateFormat;
        ...
        $this->wp->AddParameter("2", "urlofficer_id", ccsInteger, "", "", $this->Parameters["urlofficer_id"], "", false);
        ...
        $this->wp->Criterion[2] = $this->wp->Operation(opEqual, "officer_id", $this->wp->GetDBValue("2"), $this->ToSQL($this->wp->GetDBValue("2"), ccsInteger),false);
...
} //End officersDataSource Class @33-FCB6E20C

//Include Page implementation @28-3DD2EFDC
include_once(RelativePath . "/Header.php");
//End Include Page implementation

//Include Page implementation @29-39F846CD
include_once(RelativePath . "/AdminMenu.php");
//End Include Page implementation

//Initialize Page @1-0B6A6A6E
// Variables
$FileName = "";
$Redirect = "";
$Tpl = "";
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "EditOfficer.html";
$BlockToParse = "main";
...
$officers = new clsRecordofficers("", $MainPage);
